...
%changelog
* Tue Sep 15 2026 Ackerman-00 <quietcraft@gmail.com> - 1.0.8-2
- Restore 1.0.8 after auto-updater tag-sort downgrade to 1.0.7 (update.sh
  picked v1.0.7 over the newer bare 1.0.8 tag; the 1.0.7 Source 404s on
  codeload and failed COPR build 10989360); tag ordering fixed in update.sh
